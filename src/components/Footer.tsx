  ...
  return (
    <footer className="py-16 px-4 sm:px-6 relative glassmorphism border-t border-foreground/10">
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            <h4 className="text-xl font-semibold text-foreground mb-2">Partner</h4>
            <div className="w-20 h-1 bg-gradient-to-r from-reform-cyan to-reform-purple mx-auto rounded-full"></div>
          </div>
          
          <div className="bg-white/5 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/10">
            <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-8 lg:gap-12">
              ...
              >
                <img 
                  ...
                  className="h-16 lg:h-20 w-auto transition-all duration-500 group-hover:brightness-110 group-hover:drop-shadow-lg"
                />
              </a>
